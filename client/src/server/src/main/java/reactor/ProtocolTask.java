...
public class ProtocolTask implements Runnable {
	...
	private final EchoProtocol _protocol;
	private final MessageTokenizer<StringMessage> _tokenizer;
	private final ConnectionHandler _handler;

	public ProtocolTask(final EchoProtocol protocol, final MessageTokenizer<StringMessage> tokenizer, final ConnectionHandler h) {
